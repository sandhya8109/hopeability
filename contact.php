...
<body>
  ...
  <p class="sub">Call us on 1300 424 442 to talk about your needs Or fill out the form below and our Care Advisors
    will be in touch
    soon.</p>
  <style>
    ...
    <div class="container">
      <div class="row g-4">
        ...
        <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
          <div class="service-item text-center pt-3">
            <div class="p-4">
              <i class="fa-solid fa fa-3x fa-mobile-alt text-primary mb-4" style="color:#274a84;"></i>
        ...
        <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
          <div class="service-item text-center pt-3">
            <div class="p-4">
              ...
              <i class="fa-solid fa fa-3x fa-envelope-open text-primary mb-4" style="color: #274a84;"></i>
        ...
        <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
          <div class="service-item text-center pt-3">
            <div class="p-4">
              <i class="fa-solid  fa fa-3x fa-clock text-primary mb-4" style="color: #274a84;"></i>
              <h5 class="mb-3">We Are Open</h5>
