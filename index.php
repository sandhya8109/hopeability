    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.3s">
                <h6 class="section-title bg-white text-center text-primary px-3">Mission</h6>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <p class="mb-3">Our mission is to empower people with a disability to engage in opportunities of
                        their choice in a supported and inclusive environment.</p>

                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-80 h-80" src="img/full-shot-woman-with-crutches.jpg"
                            alt="" style="object-fit: cover; border-radius: 15px 45px 15px 45px; ">
                    </div>
                </div>
            </div>
        </div>
