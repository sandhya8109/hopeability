...
<head>
    <meta charset="utf-8">
    <title>Our Services- Hope Ability</title>
...
<body>
    ...
    <div class="row" style="background-color: rgb(250, 248, 248);">
        <h2>Assistance With Daily Life Tasks In A Group Or Shared Living Arrangement</h2>
        <div class="col-md-8">
            <p>We provide assistance with and/or supervising tasks of daily life in a shared living environment, which
            ...
            <p>We work under Supported Independent Living (SIL) arrangement to supervise your daily life tasks while in
            ...
            <h4 style="font-weight: 10;">We provide help with all the three levels of Supported Independent Living
                arrangements</h4>
            <ul>
            ...
            <h4 style="font-weight: 10;">We provide you as little or as much support you need including but not limited
                to</h4>
            <ul>
                <li><strong>Getting Around:</strong>Assisting you in moving around the house, such as transfers from bed
                    or chair to wheelchair or toilet.</li>
    ...
    <div class="row">
        <h2>Development Of Daily Living And Life Skills [Development-Life Skills]</h2>
        <div class="col-md-8">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <p>Being part of something beyond your front door is so important to living a fulfilling life. We are with
            ...
            <p>We focus on getting all our participants into the community. With introduction to a wide array of
